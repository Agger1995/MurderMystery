...
/**
 * Room class is used to create new a new instance object of type room Room objects holds all informations about that room. Holds which Item, SpecialItem, Person, PersonWithRiddle objects that is in
 * this room
 *
 * @author Christian
 */
public class Room {
    ...
    /**
     * Constructor for Room class. Sets instance variables and generates a new hashmap per room created The hashmap contains directions in form of "String" and the Room the direction leads to as an
     * object of type "Room".
     *
    ...
    /**
     * method that moves a Person from one Room to another Room in this.exits called from game class when a Person movement is needed
     *
    ...
    /**
     * setExit sets an exit (direction) leading to a Room (neighbor) adds a new key value set to this.exits HashMap
     *
